 ...
 *     </li>
 * </ul>
 * @property {BookmarkDao} bookmarkDao Singleton DAO implementing follows CRUD operations
...
export default class BookmarkController implements BookmarkControllerI {
   ...
   * path parameters uid and tid representing the user that is bookmarking and the tuit being
   * bookmarked
   * @param {Response} res Represents response to client, including the
  ...
  /**
   * @param {Request} req Represents request from client, including the
   * path parameters uid and tid representing the user that is unbookmarking and the tuit being
   * unbookmarked
